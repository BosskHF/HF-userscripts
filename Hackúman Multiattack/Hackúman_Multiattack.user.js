...
$(document).on("click", ".hum-attack-modal-choice", function() {
    if(isSelecting == true) {
        ...
        attackerID = $(this).attr('onclick').substring($(this).attr('onclick').lastIndexOf(", ") + 1, $(this).attr('onclick').lastIndexOf(")")); //Get ID of attacker
